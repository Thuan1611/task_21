...
### Trang quản lý sản phẩm (dành cho admin). (1đ)
...
- Xây dựng bộ định tuyến, layout và giao diện cho ứng dụng (1đ)
- Trang chủ:
  - Danh sách sản phẩm dạng lưới (0.5đ)
  - Tính năng chuyển đổi layout (0.5đ)
  - Tính năng lọc sản phẩm theo danh mục (0.5đ)
  - Tìm kiếm sản phẩm (0.5đ)
  - Tổng cộng: 2đ
- Trang đăng ký (1đ)
- Trang đăng nhập (1đ)
